...
\begin{center}
\textbf{\LARGE Geometry Without Words}\\
\mbox{}\\
...
\draw[thick] (a) rectangle +(10pt,10pt);
\end{tikzpicture}
\end{minipage}
\hspace{.1\textwidth}
%
...
%  in the center of the circumscribed circle
%
\hspace{4em}
...
\draw[thick,red] ($ (i1) !.5! (i2) $) 
  rectangle +(12pt,12pt);
\draw[thick,blue,rotate=-30] ($ (i1) !.5! (i3) $)
  rectangle +(12pt,12pt);
\draw[thick,magenta,rotate=-160] ($ (i3) !.5! (i2) $)
  rectangle +(12pt,12pt);
\end{tikzpicture}
\end{minipage}
...
% Draw radii
\draw[very thick,green!60!black] (center) -- node[below] {$\bm{r}$} (tan1);
\draw[very thick,green!60!black] (center) -- node[right] {$\bm{r}$} (tan2);
% Draw right angles
\draw[very thick,green!60!black,rotate=34] (tan1) rectangle +(12pt,12pt);
\draw[very thick,green!60!black,rotate=-168] (tan2) rectangle +(12pt,12pt);
\end{tikzpicture}
\end{minipage}
