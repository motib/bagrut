...
\begin{tikzpicture}
[grow=right,
level 1/.append style={level distance=4cm,sibling distance=12em},
level 2/.append style={level distance=5cm,sibling distance=4em}]
\node[left] {$0$} % root
child {
  node[right] {$100$}
    child {
...
\draw (0,0) grid (3,3);
\node at (2.5,3.3) {\bfseries \R{בנות}};
\node at (1.5,3.3) {\bfseries \R{בנים}};
\node at (3.3,2.5) {\bfseries \R{א}};
\node at (3.3,1.5) {\bfseries \R{ב}};
\node at (2.5,2.7) {$.4-.04=$};
\node at (2.5,2.3) {$.36$};
...
level 1/.append style={level distance=3cm,sibling distance=8em},
level 2/.append style={level distance=4cm,sibling distance=3em}]
\node[left] {$0$} % root
child {
  node[right] {$\frac{1}{2}$}
    child {
...
\addcontentsline{toc}{section}{המלצות: הסתברות}
